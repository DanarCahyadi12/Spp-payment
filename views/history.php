...
include(dirname(__DIR__) . '../backend/OOP/view/History.view.php');
$profile = new Profile();
...
<div class="overflow-x-auto  ">
  <table class="table table-zebra w-3/5 m-auto mt-20 rounded-lg shadow-lg">
    <!-- head -->
    <thead>
      <tr>
        <th></th>
